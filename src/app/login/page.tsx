...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen w-full relative flex flex-col p-6">
      
      {/* 1. Centered Logo (Absolute positioning to stay true to layout) */}
      <div className="absolute top-12 left-0 w-full flex justify-center z-10">
        <Link href="/" className="hover:opacity-80 transition-opacity">
           {/* Reusing the SVG Logo for consistency, or text if preferred */}
           <svg 
      ...
      {/* 2. Main Content Area */}
      {/* We use a grid to push the form to the right side on desktop, centered on mobile */}
      <div className="flex-grow flex items-center justify-center lg:justify-end max-w-7xl mx-auto w-full mt-24 lg:mt-0">
        
        {/* The Login Card */}
        <div className="w-full max-w-[480px] bg-[var(--color-paper)] border border-[var(--color-ink)]/20 p-8 md:p-12 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] relative mx-auto lg:mx-0 lg:mr-12">
          ...
          <form className="space-y-10">
            ...
            <div className="space-y-2">
              <label className="block font-serif text-xl text-[var(--color-ink)]">
                Email ID<span className="text-[var(--color-ink)]/60">*</span>
              </label>
              <input 
                type="email" 
            ...
            <div className="space-y-2">
              <label className="block font-serif text-xl text-[var(--color-ink)]">
                Password<span className="text-[var(--color-ink)]/60">*</span>
              </label>
            ...
            {/* Submit Button */}
            {/* Using the specific Navy Blue color #0D236D from your design */}
